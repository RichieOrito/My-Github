export class Repo {
  constructor( public name: string,public description: string, public forks_count: number, public language: string, public svn_url: string,  public created_at: Date){}
